...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class HighLowContainerRestObject
    {
        /// <summary>
        ...
        public BaseballStatsTypeRestObject SortStat { get; set; }

        /// <summary>
        /// Gets or Sets CombinedStats
        /// </summary>
        [DataMember(Name = "combinedStats", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "combinedStats")]
        public bool? CombinedStats { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HighLowContainerRestObject {\n");
            ...
            sb.Append("  CombinedStats: ").Append(CombinedStats).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
