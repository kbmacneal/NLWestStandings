...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class GameDateBroadcastRestObject
    {
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets PreGameShow
        /// </summary>
        [DataMember(Name = "preGameShow", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "preGameShow")]
        public DateTime? PreGameShow { get; set; }

        /// <summary>
        /// Gets or Sets PostGameShow
        /// </summary>
        [DataMember(Name = "postGameShow", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "postGameShow")]
        ...
        public List<FreeGameValueRestObject> FreeGameTypes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GameDateBroadcastRestObject {\n");
            ...
            sb.Append("  PreGameShow: ").Append(PreGameShow).Append("\n");
            sb.Append("  PostGameShow: ").Append(PostGameShow).Append("\n");
