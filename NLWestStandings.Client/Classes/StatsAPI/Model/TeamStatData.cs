...
namespace IO.Swagger.Model
{
    ...
    public class TeamStatData
    {
        ...
        /// </summary>
        [DataMember(Name = "winStreak", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "winStreak")]
        public int? WinStreak { get; set; }

        /// <summary>
        /// Gets or Sets LossStreak
        /// </summary>
        [DataMember(Name = "lossStreak", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "lossStreak")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WinStreak: ").Append(WinStreak).Append("\n");
            sb.Append("  LossStreak: ").Append(LossStreak).Append("\n");
