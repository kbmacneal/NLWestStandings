...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class StreaksContainerRestObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets StreakStat
        /// </summary>
        [DataMember(Name = "streakStat", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "streakStat")]
        public StreakStatEnum StreakStat { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreaksContainerRestObject {\n");
            ...
            sb.Append("  StreakStat: ").Append(StreakStat).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
