...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class BaseballLineupRestObject
    {
        /// <summary>
        ...
        public List<BaseballPersonRestObject> HomePlayers { get; set; }
        ...
        public List<BaseballPersonRestObject> AwayPlayers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseballLineupRestObject {\n");
