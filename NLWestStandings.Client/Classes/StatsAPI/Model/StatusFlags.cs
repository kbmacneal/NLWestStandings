...
namespace IO.Swagger.Model
{
    ...
    public class StatusFlags
    {
        ...
        /// <summary>
        /// Gets or Sets IsChampionshipSeries
        /// </summary>
        [DataMember(Name = "isChampionshipSeries", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "isChampionshipSeries")]
        public bool? IsChampionshipSeries { get; set; }
        ...
        /// <summary>
        /// Gets or Sets IsInGamDelay
        /// </summary>
        [DataMember(Name = "isInGamDelay", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "isInGamDelay")]
        public bool? IsInGamDelay { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsChampionshipSeries: ").Append(IsChampionshipSeries).Append("\n");
            sb.Append("  IsWorldSeries: ").Append(IsWorldSeries).Append("\n");
            sb.Append("  IsPreGameDelay: ").Append(IsPreGameDelay).Append("\n");
            sb.Append("  IsInGamDelay: ").Append(IsInGamDelay).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
